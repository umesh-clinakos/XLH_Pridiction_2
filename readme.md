...
Vignette: [Using the package skeleton for patient-level prediction studies](https://raw.githubusercontent.com/OHDSI/StudyProtocolSandbox/master/XLHPridiction/inst/doc/UsingSkeletonPackage.pdf)
...
```r
  library(XLHPridiction)
  # USER INPUTS
#=======================
# The folder where the study intermediate and result files will be written:
outputFolder <- "./XLHPridictionResults"
...
cohortTable <- 'XLHPridictionCohort'
#=======================
...
```r
  ...
  devtools::install_github("OHDSI/StudyProtocolSandbox/XLHPridiction")
```
