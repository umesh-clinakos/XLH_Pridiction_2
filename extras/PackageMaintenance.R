...
OhdsiRTools::checkUsagePackage("XLHPridiction")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/XLHPridiction.pdf")
shell("R CMD Rd2pdf ./ --output=extras/XLHPridiction.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("XLHPridiction")
